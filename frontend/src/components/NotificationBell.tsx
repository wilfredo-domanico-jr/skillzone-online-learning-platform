...
export default function NotificationBell() {
    ...
    return (
        <Popover className="relative">
            <PopoverButton className="relative flex h-9 w-9 items-center justify-center rounded-full text-white/70 transition-colors hover:bg-white/10 hover:text-white focus:outline-none">
            ...
            <PopoverPanel
                transition
                className="card absolute right-0 z-20 mt-2 w-80 overflow-hidden !rounded-2xl py-0 text-left shadow-xl
